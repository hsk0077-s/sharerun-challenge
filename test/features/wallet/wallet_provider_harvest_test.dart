...
void main() {
  ...
  test('shop DIA debit survives stale 1M grant hydrate', () {
    const remote = WalletModel(
      shareBalance: 1000000,
      diamondBalance: 1000000,
      valueTokenBalance: 1000000,
  ...
  test('HoF VALUE debit and angel SHARE debit survive 1M remotes', () {
    const remote = WalletModel(
      shareBalance: 1000000,
      diamondBalance: 1000000,
      valueTokenBalance: 1000000,
    ...
    final notifier = container.read(walletProvider.notifier);
    notifier.replaceFromRemote(remote);
    notifier.subtractShare(50000);
    notifier.debitValue(500);
  ...
  test('mergeRemote does not refill spent DIA/VALUE to the 1M grant', () {
    const current = WalletState(
      shareBalance: 950000,
    ...
    expect(merged.shareBalance, 950000);
    expect(merged.diamondBalance, 999970);
